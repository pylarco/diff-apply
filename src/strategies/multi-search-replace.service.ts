...
Only use a single line of '=======' between search and replacement content, because multiple '=======' will corrupt the file.
      ...
      applyDiff: (
        ...
        _paramStartLine?: number, // Keep these for consistency, even if unused
        _paramEndLine?: number,   // Keep these for consistency, even if unused
      ): DiffResult => {
        let matches = [
...
const self = multiSearchReplaceService.multiSearchReplaceService
export const { applyDiff, getSimilarity, getToolDescription } = self
