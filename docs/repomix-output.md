...
```typescript
import { applyDiff, getToolDescription } from "../multi-search-replace.service";

describe("multiSearchReplaceService", () => {
...
```typescript
import { create } from "../new-unified"
...
```typescript
import { applyDiff, getToolDescription } from "../unified.service"
